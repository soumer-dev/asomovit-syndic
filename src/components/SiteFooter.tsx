      ...
      <div className="container mx-auto grid gap-10 px-4 py-14 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-3">
            <img src={logo} alt="ASOMOVIT SYNDIC" className="h-12 w-auto rounded-md bg-white p-1" />
            <div>
          ...
          <div className="mt-5 flex gap-3">
            ...
            <a href="#" aria-label="LinkedIn" className="rounded-full bg-white/10 p-2 transition hover:bg-white/20">
        ...
        <div>
          <h3 className="font-heading text-sm font-semibold uppercase tracking-wider">Liens rapides</h3>
          <ul className="mt-4 space-y-2 text-sm opacity-90">
            ...
            <li><Link to="/contact" className="hover:text-accent">Contact / Devis</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm opacity-90">
            <li className="flex items-start gap-2">
              ...
              <a href="tel:+212661901209" className="hover:text-accent">+212 661-901209</a>
            </li>
            <li className="flex items-start gap-2">
              <Mail className="mt-0.5 h-4 w-4 shrink-0 text-accent" />
              <a href="mailto:direction@asomovitmultiservices.com" className="break-all hover:text-accent">
